...
| Phase | What | Status |
|-------|------|--------|
| **Core + Methodology** | Constitution, routing, onboarding, developer-aware context, project lifecycle, templates, structured reflection, workflow gap detection, version awareness, project index | v0.3.0 (March 2026) |
