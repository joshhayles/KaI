...
| Phase | What | Status |
|-------|------|--------|
| **Core + Methodology** | Constitution, routing, onboarding, developer-aware context, project lifecycle, templates, structured reflection, workflow gap detection | v0.2.1 (March 2026) |
